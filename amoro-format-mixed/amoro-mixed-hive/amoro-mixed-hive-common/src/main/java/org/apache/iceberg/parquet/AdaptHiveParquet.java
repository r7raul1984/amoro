  ...
  public static class WriteBuilder {
    ...
    public <D> FileAppender<D> build() throws IOException {
      ...
      if (createWriterFunc != null) {
        ...
        return new AdaptHiveParquetWriter<>(
            conf,
            file,
            schema,
            rowGroupSize,
    ...
    public <D> CloseableIterable<D> build() {
      if (readerFunc != null || batchedReaderFunc != null) {
        ...
        ParquetReadOptions options = optionsBuilder.build();
          ServiceLoader<HiveParquetAdapter> loader = ServiceLoader.load(HiveParquetAdapter.class);
          HiveParquetAdapter hiveParquetAdapter = loader.findFirst()
                  .orElseThrow(() -> new IllegalStateException("No HiveParquetAdapter providers found"));
        ...
        if (batchedReaderFunc != null) {
          ...
          // Change for mixed-hive table ⬇
          return hiveParquetAdapter.createParquetReader(
              file,
              schema,
              options,
              readerFunc,
