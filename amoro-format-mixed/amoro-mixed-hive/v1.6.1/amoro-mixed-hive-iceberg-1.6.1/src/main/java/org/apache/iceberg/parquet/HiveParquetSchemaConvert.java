...
public class HiveParquetSchemaConvert implements HiveParquetSchemaConvertAdapter{
    public MessageType pruneColumns(MessageType fileSchema, Schema expectedSchema) {
